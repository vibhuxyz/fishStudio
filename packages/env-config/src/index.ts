...
export const ENV = {
  ...
  TWILIO_ACCOUNT_SID: logEnv("TWILIO_ACCOUNT_SID", process.env.TWILIO_ACCOUNT_SID),
  TWILIO_API_KEY: logEnv("TWILIO_API_KEY", process.env.TWILIO_API_KEY),
  TWILIO_API_SECRET: logEnv("TWILIO_API_SECRET", process.env.TWILIO_API_SECRET),
  TWILIO_AUTH_TOKEN: logEnv("TWILIO_AUTH_TOKEN", process.env.TWILIO_AUTH_TOKEN),
  TWILIO_PHONE_NUMBER: logEnv("TWILIO_PHONE_NUMBER", process.env.TWILIO_PHONE_NUMBER),
