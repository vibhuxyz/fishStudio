...
export const getAdmin = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    res.status(200).json({
      success: true,
      admin: req.admin,
...
export const logOutAdmin = async (req: AuthenticatedRequest, res: Response) => {
