...
const StepIndicator = ({ currentStep, steps, accentColor = "blue" }: StepIndicatorProps) => {
  ...
  return (
    <div className="w-full flex items-center justify-between mb-12 relative px-4">
      ...
      <motion.div 
        ...
        className={`absolute top-1/2 left-0 h-[3px] ${activeBg} shadow-[0_0_15px_rgba(59,130,246,0.4)] -translate-y-1/2 z-0 transition-all duration-700 ease-out`}
      />
