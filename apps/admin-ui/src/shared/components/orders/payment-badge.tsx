...
// Admin's palette for the shared payment vocabulary. The labels come from
// @repo/shared/payment-state; only the colours are local.
...
const PILL_TONE: Record<PaymentTone, string> = {
  ...
  pending: "bg-amber-900/40 text-amber-400 border border-amber-900/30",
