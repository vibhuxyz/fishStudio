  ...
  const applyAIFeature = async (feature: string) => {
    ...
    try {
      ...
      const trMap: Record<string, string> = {
        "bg-remove": "e-bgremove",
        relight: "e-relight",
        "quality-improve": "e-retouch",
      };
  ...
  const menuItems = [
    {
      id: "orders",
      title: "My Orders",
      subtitle: `${ordersLoading ? "..." : ordersCount} order${ordersCount !== 1 ? "s" : ""} placed`,
      icon: "bag-outline",
      iconColor: "#2563EB",
      iconBg: "#DBEAFE",
              ...
              <>
                      ...
                      source={{
                        uri:
                          ...
                          "https://ui-avatars.com/api/?name=" +
                            ...
                            "&background=6C3CE1&color=fff&size=150",
                      }}
                  ...
                  <View className="ml-4 flex-1">
                    <Text
                      ...
                      style={{
                        fontFamily: "Poppins-Bold",
                        fontWeight:
                          Platform.OS === "android" ? "700" : "normal",
                      }}
                      numberOfLines={1}
                    >
                      {user?.name || "—"}
                    ...
                    {user?.email ? (
                      <View className="flex-row items-center mt-1">
                        ...
                        />
                        <Text
                          className="text-gray-500 font-poppins-medium text-xs ml-1"
                          numberOfLines={1}
                        >
                          {user.email}
                        </Text>
                ...
                <View className="flex-row gap-3">
                  ...
                  <View className="flex-1 bg-blue-50 rounded-xl p-3 items-center">
                    ...
                    <Text className="text-[10px] text-gray-500 font-poppins-medium">
                      Orders
                    </Text>
                  </View>
                  ...
                  <View className="gap-3">
                    ...
                    {[
                      ...
                      >
                        ...
                        <Text className="flex-1 font-poppins-semibold text-gray-900">
                          {f.label}
                        </Text>
                        {appliedFeatures.includes(f.key) && (
                          <Ionicons
  ...
  return (
    ...
    >
      ...
      <View className="flex-1">
        ...
        <Text
          className="text-sm text-gray-900 font-poppins-medium mt-0.5"
          numberOfLines={1}
        >
          {value}
        </Text>
